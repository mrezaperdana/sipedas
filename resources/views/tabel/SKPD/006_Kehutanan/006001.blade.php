        ...
        <table class="table table-bordered">
            <thead>
                ...
                <tr>
                    ...
                    <th class="tg-jkyp"><span style="font-weight:normal">{{ $data->tahun }}</span></th>
                </tr>
            </thead>
            <tbody>
                <tr>
...
@section('script')
    <script>
        function sumPs() {
            ...
            var p6 = parseFloat(document.getElementById('p6').value) || 0;
            var p7 = parseFloat(document.getElementById('p7').value) || 0;
            var p8 = parseFloat(document.getElementById('p8').value) || 0;
            var p9 = parseFloat(document.getElementById('p9').value) || 0;
            var p10 = parseFloat(document.getElementById('p10').value) || 0;
            var p11 = parseFloat(document.getElementById('p11').value) || 0;
            var p12 = parseFloat(document.getElementById('p12').value) || 0;
            var pSum = (p1) + (p2) + (p3) + (p4) + (
                p5) + (p6) + (p7) + (p8) + (p9) + (
                p10) + (
                p11) + (p12);

            document.getElementById('pt').value = pSum;
        }

        document.getElementById('p1').addEventListener('focusout', sumPs);
        document.getElementById('p2').addEventListener('focusout', sumPs);
        document.getElementById('p3').addEventListener('focusout', sumPs);
        document.getElementById('p4').addEventListener('focusout', sumPs);
        document.getElementById('p5').addEventListener('focusout', sumPs);
        document.getElementById('p6').addEventListener('focusout', sumPs);
        document.getElementById('p7').addEventListener('focusout', sumPs);
        document.getElementById('p8').addEventListener('focusout', sumPs);
        document.getElementById('p9').addEventListener('focusout', sumPs);
        document.getElementById('p10').addEventListener('focusout', sumPs);
        document.getElementById('p11').addEventListener('focusout', sumPs);
        document.getElementById('p12').addEventListener('focusout', sumPs);
    </script>
@endsection
