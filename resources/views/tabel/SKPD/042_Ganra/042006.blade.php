<x-tabel-entri-view :data="$data" :judultabel="$judultabel" :judultabelen="$judultabelen">
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th class="tg-sn55"><span style="font-weight:bold;font-style:italic">Number of Poor Letter and
                                Poor
                                Health Insurance Card by Villages/Urban Villages in Ganra Subdistrict, 2021</span></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        <td class="tg-cly1">001. Belo</td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">45</span></td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">106</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">002. Ganra</td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">26</span></td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">100</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">003. Enrekeng</td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">17</span></td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">1736</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">004. Lompulle</td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">35</span></td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">105</span></td>
                    </tr>
                    <tr>
                        <td class="tg-baqh"><span style="font-style:normal;color:#000">Jumlah/</span><span
                                style="font-style:italic;color:#000">Total</span></td>
                        <td class="tg-mwxe">193</td>
                        <td class="tg-mwxe">2047</td>
                    </tr>
                </tbody>
            </table>
        </x-slot>
    ...
    <x-slot name="script">
        {{-- //script disini --}}
        @include('tabel.skpd.042_ganra.script6')
    </x-slot>
</x-tabel-entri-view>
