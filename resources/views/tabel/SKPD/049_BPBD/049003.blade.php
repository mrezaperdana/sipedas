...
@else
    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                <th class="tg-wa1i"><span style="font-weight:bold">Tabel</span></th>
                <th class="tg-yla0" colspan="3"><span style="font-weight:bold">Jumlah Kerusakan Rumah yang
        ...
        <tbody>
            <tr>
                <td class="tg-xxp7"><span style="font-weight:bold;font-style:italic">Table</span></td>
                <td class="tg-sn55" colspan="3"><span style="font-weight:bold;font-style:italic">Number of House
                        Damaged Caused by Natural Disaster by Subdistrict in Soppeng Regency, 2021</span></td>
            </tr>
            <tr>
                <td class="tg-7zrl"></td>
                <td class="tg-7zrl"></td>
            ...
            <tr>
                ...
                <td class="tg-iygw"><span style="background-color:#D7F3CB">&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;</span></td>
                <td class="tg-iygw"><span style="background-color:#D7F3CB">&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;</span></td>
                <td class="tg-iygw"><span style="background-color:#D7F3CB">&nbsp;&nbsp;48 </span></td>
            </tr>
            <tr>
                <td class="tg-cly1">060. Marioriawa</td>
                <td class="tg-iygw"><span style="background-color:#D7F3CB">&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;</span></td>
