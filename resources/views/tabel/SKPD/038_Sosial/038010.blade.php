        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th class="tg-cly1" colspan="4">{{ $data->tahun }}
                        {{ $judultabel }}, {{ $data->tahun }}</th>
                </tr>
                <tr>
        ...
        <thead>
            <tr>
                ...
                <th class="tg-cly1" colspan="4">Banyaknya Penyandang Cacat Menurut Desa/Kelurahan dan Jenis Cacat
                    di
                    Kecamatan Marioriawa, 2021</th>
            </tr>
            <tr>
                <th class="tg-xxp7"><span style="font-weight:bold;font-style:italic">Table</span></th>
                <th class="tg-xxp7" colspan="4"><span style="font-weight:bold;font-style:italic">Number of People
                        with Disabilities by Villages/Urban Villages and Type of Disability in Marioriawa Subdistrict,
                        2021</span></th>
            </tr>
        </thead>
        <tbody>
