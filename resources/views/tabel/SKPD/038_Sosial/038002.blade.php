    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                <th class="tg-wa1i"><span style="font-weight:bold">Tabel</span></th>
                <th class="tg-amwm" rowspan="2">4.5.14</th>
                <th class="tg-wa1i" colspan="4"><span style="font-weight:bold">Banyaknya Penyandang Cacat Tubuh,
                        Tuna Netra, Tuna Karya dan Tuna Susila Menurut Kecamatan di Kabupaten Soppeng, 2021</span></th>
            </tr>
            <tr>
                <th class="tg-xxp7"><span style="font-weight:bold;font-style:italic">Table</span></th>
                <th class="tg-xxp7" colspan="4"><span style="font-weight:bold;font-style:italic">Number of Person
                        with Disability by Subdistrict in Soppeng Regency, 2021</span></th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                <td class="tg-cly1">030. Liliriaja</td>
                <td class="tg-cly1"><input type="text" class="form-control @error('blind3') is-invalid @enderror"
                        id="blind3" name="blind3" value="{{ old('blind3', $data->blind3) }}">
                    @error('blind3')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <td class="tg-cly1"><input type="text" class="form-control @error('deaf3') is-invalid @enderror"
                        id="deaf3" name="deaf3" value="{{ old('deaf3', $data->deaf3) }}">
                    @error('deaf3')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <tr>
                <td class="tg-cly1">031. Ganra</td>
                <td class="tg-cly1"><input type="text" class="form-control @error('blind4') is-invalid @enderror"
                        id="blind4" name="blind4" value="{{ old('blind4', $data->blind4) }}">
                    @error('blind4')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <td class="tg-cly1"><input type="text" class="form-control @error('deaf4') is-invalid @enderror"
                        id="deaf4" name="deaf4" value="{{ old('deaf4', $data->deaf4) }}">
                    @error('deaf4')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <tr>
                <td class="tg-cly1">032. Citta</td>
                <td class="tg-cly1"><input type="text" class="form-control @error('blind5') is-invalid @enderror"
                        id="blind5" name="blind5" value="{{ old('blind5', $data->blind5) }}">
                    @error('blind5')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <td class="tg-cly1"><input type="text" class="form-control @error('deaf5') is-invalid @enderror"
                        id="deaf5" name="deaf5" value="{{ old('deaf5', $data->deaf5) }}">
                    @error('deaf5')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <tr>
                <td class="tg-cly1">040. Lilirilau</td>
                <td class="tg-cly1"><input type="text" class="form-control @error('blind6') is-invalid @enderror"
                        id="blind6" name="blind6" value="{{ old('blind6', $data->blind6) }}">
                    @error('blind6')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <td class="tg-cly1"><input type="text" class="form-control @error('deaf6') is-invalid @enderror"
                        id="deaf6" name="deaf6" value="{{ old('deaf6', $data->deaf6) }}">
                    @error('deaf6')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <tr>
                <td class="tg-cly1">050. Donri-Donri</td>
                <td class="tg-cly1"><input type="text" class="form-control @error('blind7') is-invalid @enderror"
                        id="blind7" name="blind7" value="{{ old('blind7', $data->blind7) }}">
                    @error('blind7')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <td class="tg-cly1"><input type="text" class="form-control @error('deaf7') is-invalid @enderror"
                        id="deaf7" name="deaf7" value="{{ old('deaf7', $data->deaf7) }}">
                    @error('deaf7')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <tr>
                <td class="tg-cly1">060. Marioriawa</td>
                <td class="tg-cly1"><input type="text" class="form-control @error('blind8') is-invalid @enderror"
                        id="blind8" name="blind8" value="{{ old('blind8', $data->blind8) }}">
                    @error('blind8')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <td class="tg-cly1"><input type="text" class="form-control @error('deaf8') is-invalid @enderror"
                        id="deaf8" name="deaf8" value="{{ old('deaf8', $data->deaf8) }}">
                    @error('deaf8')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <tr>
                <td class="tg-baqh"><span style="font-style:normal;color:#000">Jumlah</span><span
                        style="font-style:italic;color:#000">/Total</span></td>
                <td class="tg-cly1"><input type="text" class="form-control @error('blindt') is-invalid @enderror"
                        id="blindt" name="blindt" value="{{ old('blindt', $data->blindt) }}">
                    @error('blindt')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <td class="tg-cly1"><input type="text" class="form-control @error('deaft') is-invalid @enderror"
                        id="deaft" name="deaft" value="{{ old('deaft', $data->deaft) }}">
                    @error('deaft')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
