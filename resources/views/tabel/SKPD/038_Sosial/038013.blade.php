    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                <th class="tg-wa1i"><span style="font-weight:bold">Tabel</span></th>
                <th class="tg-amwm" rowspan="2">4.5.14</th>
                <th class="tg-wa1i" colspan="4"><span style="font-weight:bold">Banyaknya kelompok Usaha Bersama
                        menurut kecamatan di kabupaten soppeng thn 2021</span></th>
            </tr>
            <tr>
                <th class="tg-xxp7"><span style="font-weight:bold;font-style:italic">Table</span></th>
                <th class="tg-xxp7" colspan="4"><span style="font-weight:bold;font-style:italic">The Number of
                        joint Business Groups According to sub districts in soppeng district in 2021</span></th>
            </tr>
        </thead>
        <tbody>
            <tr>
