        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th class="tg-wa1i" colspan="4"><span style="font-weight:bold">{{ $judultabel }} Tahun
                            {{ $data->tahun }}</span></th>
                </tr>
                <tr>
    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                <th class="tg-wa1i"><span style="font-weight:bold">Tabel</span></th>
                <th class="tg-amwm" rowspan="2">4.5.14</th>
                <th class="tg-wa1i" colspan="4"><span style="font-weight:bold">Banyaknya Penerima Beras
                        Sejahtera APBD Menurut&nbsp;&nbsp;Kecamatan di Kabupaten Soppeng Tahun 2021</span></th>
            </tr>
            <tr>
                <th class="tg-xxp7"><span style="font-weight:bold;font-style:italic">Table</span></th>
                <th class="tg-xxp7" colspan="4"><span style="font-weight:bold;font-style:italic">Number of
                        Prosperous Rice Recipients in APBD by Sub-Districts in Soppeng Regency in 2021</span></th>
            </tr>
        </thead>
        <tbody>
            <tr>
            ...
            <tr>
                ...
                <td class="tg-5si3"></td>
                <td class="tg-5si3"></td>
                <td class="tg-lec9"><span style="background-color:#D7F3CB"> 290 </span></td>
                <td class="tg-5si3"></td>
                <td class="tg-5si3"></td>
            </tr>
            <tr>
                ...
                <td class="tg-5si3"></td>
                <td class="tg-5si3"></td>
                <td class="tg-lec9"><span style="background-color:#D7F3CB"> 394 </span></td>
                <td class="tg-5si3"></td>
                <td class="tg-5si3"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="tg-5si3"></td>
                <td class="tg-5si3"></td>
                <td class="tg-lec9"><span style="background-color:#D7F3CB"> 60 </span></td>
                <td class="tg-5si3"></td>
                <td class="tg-5si3"></td>
            </tr>
            <tr>
                ...
                <td class="tg-5si3"></td>
                <td class="tg-5si3"></td>
                <td class="tg-lec9"><span style="background-color:#D7F3CB"> 150 </span></td>
                <td class="tg-5si3"></td>
                <td class="tg-5si3"></td>
            </tr>
            <tr>
                ...
                <td class="tg-5si3"></td>
                <td class="tg-5si3"></td>
                <td class="tg-lec9"><span style="background-color:#D7F3CB"> 198 </span></td>
                <td class="tg-5si3"></td>
                <td class="tg-5si3"></td>
            </tr>
            <tr>
