        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="tg-cly1"><input type="text"
                            class="form-control @error('blind13') is-invalid @enderror" id="blind13"
                            name="blind13" value="{{ old('blind13', $data->blind13) }}">
                        @error('blind13')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <td class="tg-cly1"><input type="text"
                            class="form-control @error('deaf13') is-invalid @enderror" id="deaf13" name="deaf13"
                            value="{{ old('deaf13', $data->deaf13) }}">
                        @error('deaf13')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <td class="tg-cly1"><input type="text"
                            class="form-control @error('mentally_disabled13') is-invalid @enderror"
                            id="mentally_disabled13" name="mentally_disabled13"
                            value="{{ old('mentally_disabled13', $data->mentally_disabled13) }}">
                        @error('mentally_disabled13')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        @enderror
                    ...
                    <td class="tg-cly1"><input type="text"
                            class="form-control @error('disabled13') is-invalid @enderror" id="disabled13"
                            name="disabled13" value="{{ old('disabled13', $data->disabled13) }}">
                        @error('disabled13')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <td class="tg-cly1"><input type="text"
                            class="form-control @error('multiple_dissability13') is-invalid @enderror"
                            id="multiple_dissability13" name="multiple_dissability13"
                            value="{{ old('multiple_dissability13', $data->multiple_dissability13) }}">
                        @error('multiple_dissability13')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        @enderror
        ...
        <thead>
            <tr>
                ...
                <th class="tg-wa1i" colspan="4"><span style="font-weight:bold">Banyaknya Penyandang Cacat Menurut
                        Desa/Kelurahan dan Jenis Cacat di Kecamatan Marioriwawo, 2021</span></th>
            </tr>
            <tr>
                <th class="tg-xxp7"><span style="font-weight:bold;font-style:italic">Table</span></th>
                <th class="tg-xxp7" colspan="4"><span style="font-weight:bold;font-style:italic">Number of People
                        with Disabilities by Villages/Urban Villages and Type of Disability in Marioriwawo Subdistrict,
                        2021</span></th>
            </tr>
        </thead>
        <tbody>
