        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th class="tg-amwm" rowspan="2">4.24</th>
    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                <th class="tg-wa1i"><span style="font-weight:bold">Tabel</span></th>
                <th class="tg-amwm" rowspan="2">4.24</th>
                <th class="tg-wa1i" colspan="4"><span style="font-weight:bold">T Banyaknya Penyandang Cacat
                        Menurut
                        Desa/Kelurahan dan Jenis Cacat di Kecamatan Lalabata, 2021</span></th>
            </tr>
            <tr>
                <th class="tg-xxp7"><span style="font-weight:bold;font-style:italic">Table</span></th>
                <th class="tg-xxp7" colspan="4"><span style="font-weight:bold;font-style:italic">Number of People
                        with Disabilities by Villages/Urban Villages and Type of Disability in Lalabata Subdistrict,
                        2021</span></th>
            </tr>
        </thead>
        <tbody>
