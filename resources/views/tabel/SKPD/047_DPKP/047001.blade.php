            ...
            <thead>
                <tr>
                    ...
                    <th class="tg-wa1i"><span style="font-weight:bold">Banyaknya Rumah Permanen, Rumah Sehat dan Rumah
                            Tidak
                            Sehat Menurut Desa/Kelurahan di Kecamatan Citta, {{ $data->tahun }}</span></th>
                </tr>
                <tr>
                    <th class="tg-xxp7"><span style="font-weight:bold;font-style:italic">Table</span></th>
                    <th class="tg-xxp7"><span style="font-weight:bold;font-style:italic">Number of Permanent, Healthy
                            and
                            Non-Healthy House by Villages/Urban Villages in Citta Subdistrict,
                            {{ $data->tahun }}</span></th>
                </tr>
            </thead>
            <tbody>
        ...
        <thead>
            ...
            <tr>
                ...
                <th class="tg-xxp7"><span style="font-weight:bold;font-style:italic">Number of Permanent, Healthy and
                        Non-Healthy House by Villages/Urban Villages in Citta Subdistrict, {{ $data->tahun }}</span>
                </th>
            </tr>
        </thead>
        <tbody>
