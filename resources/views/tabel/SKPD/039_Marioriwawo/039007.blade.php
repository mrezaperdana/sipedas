<x-tabel-entri-view :data="$data" :judultabel="$judultabel" :judultabelen="$judultabelen">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('football10') is-invalid @enderror" id="football10"
                                name="football10" value="{{ old('football10', $data->football10) }}">
                            @error('football10')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('volley10') is-invalid @enderror" id="volley10"
                                name="volley10" value="{{ old('volley10', $data->volley10) }}">
                            @error('volley10')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('tennis10') is-invalid @enderror" id="tennis10"
                                name="tennis10" value="{{ old('tennis10', $data->tennis10) }}">
                            @error('tennis10')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('badminton10') is-invalid @enderror" id="badminton10"
                                name="badminton10" value="{{ old('badminton10', $data->badminton10) }}">
                            @error('badminton10')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('table_tennis10') is-invalid @enderror"
                                id="table_tennis10" name="table_tennis10"
                                value="{{ old('table_tennis10', $data->table_tennis10) }}">
                            @error('table_tennis10')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            @enderror
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('basketball10') is-invalid @enderror" id="basketball10"
                                name="basketball10" value="{{ old('basketball10', $data->basketball10) }}">
                            @error('basketball10')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <tr>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('football11') is-invalid @enderror" id="football11"
                                name="football11" value="{{ old('football11', $data->football11) }}">
                            @error('football11')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('volley11') is-invalid @enderror" id="volley11"
                                name="volley11" value="{{ old('volley11', $data->volley11) }}">
                            @error('volley11')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('tennis11') is-invalid @enderror" id="tennis11"
                                name="tennis11" value="{{ old('tennis11', $data->tennis11) }}">
                            @error('tennis11')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('badminton11') is-invalid @enderror" id="badminton11"
                                name="badminton11" value="{{ old('badminton11', $data->badminton11) }}">
                            @error('badminton11')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('table_tennis11') is-invalid @enderror"
                                id="table_tennis11" name="table_tennis11"
                                value="{{ old('table_tennis11', $data->table_tennis11) }}">
                            @error('table_tennis11')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            @enderror
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('basketball11') is-invalid @enderror" id="basketball11"
                                name="basketball11" value="{{ old('basketball11', $data->basketball11) }}">
                            @error('basketball11')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <tr>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('football12') is-invalid @enderror" id="football12"
                                name="football12" value="{{ old('football12', $data->football12) }}">
                            @error('football12')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('volley12') is-invalid @enderror" id="volley12"
                                name="volley12" value="{{ old('volley12', $data->volley12) }}">
                            @error('volley12')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('tennis12') is-invalid @enderror" id="tennis12"
                                name="tennis12" value="{{ old('tennis12', $data->tennis12) }}">
                            @error('tennis12')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('badminton12') is-invalid @enderror" id="badminton12"
                                name="badminton12" value="{{ old('badminton12', $data->badminton12) }}">
                            @error('badminton12')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('table_tennis12') is-invalid @enderror"
                                id="table_tennis12" name="table_tennis12"
                                value="{{ old('table_tennis12', $data->table_tennis12) }}">
                            @error('table_tennis12')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            @enderror
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('basketball12') is-invalid @enderror" id="basketball12"
                                name="basketball12" value="{{ old('basketball12', $data->basketball12) }}">
                            @error('basketball12')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <tr>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('football13') is-invalid @enderror" id="football13"
                                name="football13" value="{{ old('football13', $data->football13) }}">
                            @error('football13')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('volley13') is-invalid @enderror" id="volley13"
                                name="volley13" value="{{ old('volley13', $data->volley13) }}">
                            @error('volley13')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('tennis13') is-invalid @enderror" id="tennis13"
                                name="tennis13" value="{{ old('tennis13', $data->tennis13) }}">
                            @error('tennis13')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('badminton13') is-invalid @enderror" id="badminton13"
                                name="badminton13" value="{{ old('badminton13', $data->badminton13) }}">
                            @error('badminton13')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('table_tennis13') is-invalid @enderror"
                                id="table_tennis13" name="table_tennis13"
                                value="{{ old('table_tennis13', $data->table_tennis13) }}">
                            @error('table_tennis13')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            @enderror
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('basketball13') is-invalid @enderror" id="basketball13"
                                name="basketball13" value="{{ old('basketball13', $data->basketball13) }}">
                            @error('basketball13')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <thead>
                    <tr>
                        ...
                        <th class="tg-wa1i" colspan="4"><span style="font-weight:bold">Banyaknya Fasilitas
                                Olahraga Menurut
                                Desa/Kelurahan di Kecamatan Marioriwawo, 2021</span></th>
                    </tr>
                    <tr>
                        <th class="tg-xxp7"><span style="font-weight:bold;font-style:italic">Table</span></th>
                        <th class="tg-xxp7" colspan="4"><span style="font-weight:bold;font-style:italic">Number of
                                Sport
                                Facilities by Villages/Urban Villages in Marioriwawo Subdistrict, 2021</span></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        <td class="tg-cly1">001. Gattareng</td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">2</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">1</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">-</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">-</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">-</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="tg-cly1">3005. Goarie</td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">3</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">3</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">-</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">2</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">5</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">0206. Barae</td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">2</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">3</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">-</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">1</span></td>
                    ...
                    <tr>
                        <td class="tg-cly1">0027. Mariorilau</td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">2</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">4</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">-</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">1</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">1</span></td>
                    </tr>
    ...
    <x-slot name="script">
        {{-- //script disini --}}
        @include('tabel.skpd.039_marioriwawo.script7')
