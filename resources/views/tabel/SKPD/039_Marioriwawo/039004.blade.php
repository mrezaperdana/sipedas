<x-tabel-entri-view :data="$data" :judultabel="$judultabel" :judultabelen="$judultabelen">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('lingkungan13') is-invalid @enderror" id="lingkungan13"
                                name="lingkungan13" value="{{ old('lingkungan13', $data->lingkungan13) }}">
                            @error('lingkungan13')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('dusun13') is-invalid @enderror" id="dusun13"
                                name="dusun13" value="{{ old('dusun13', $data->dusun13) }}">
                            @error('dusun13')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('rw13') is-invalid @enderror" id="rw13"
                                name="rw13" value="{{ old('rw13', $data->rw13) }}">
                            @error('rw13')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('rt13') is-invalid @enderror" id="rt13"
                                name="rt13" value="{{ old('rt13', $data->rt13) }}">
                            @error('rt13')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th class="tg-wa1i" colspan="3"><span style="font-weight:bold">Banyaknya Lingkungan,
                                Dusun, RW dan
                                RT Menurut Desa/Kelurahan di Kecamatan Marioriwawo, 2021</span></th>
                    </tr>
                    <tr>
                        <th class="tg-xxp7"><span style="font-weight:bold;font-style:italic">Table</span></th>
                        <th class="tg-ihln" colspan="3"><span
                                style="font-weight:bold;font-style:italic;color:#000">Number
                                of Urban Backwoods, Backwoods, Hamlets and Neighbourhoods</span><span
                                style="font-weight:bold;font-style:normal;color:#000"> </span><span
                                style="font-weight:bold;font-style:italic;color:#000">by Villages/Urban Villages in
                                Marioriwawo
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">7</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">16</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">002. Marioriaja</td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">-</span></td>
                        ...
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">19</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">003. Watu </td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">-</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">2</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">6</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">19</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">004. Marioritengnga</td>
                        ...
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">13</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">005. Goarie</td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">-</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">3</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">3</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">14</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">006. Barae</td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">-</span></td>
                    ...
                    <tr>
                        ...
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">-</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">4</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">12</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">25</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">008. Tettikenrarae</td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">2</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">-</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">6</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">24</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">009. Labessi</td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">2</span></td>
                    ...
                    <tr>
                        ...
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">-</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">4</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">8</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">18</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">012. Gattareng Toa</td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">-</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">2</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">6</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">11</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">013. Soga</td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">-</span></td>
                    ...
                    <tr>
                        ...
                        <td class="tg-mwxe">29</td>
                        <td class="tg-mwxe">80</td>
                        <td class="tg-mwxe">214</td>
                    </tr>
                </tbody>
            </table>
        </x-slot>
    ...
    <x-slot name="script">
        ...
        @include('tabel.skpd.039_marioriwawo.script4')
    </x-slot>
</x-tabel-entri-view>
