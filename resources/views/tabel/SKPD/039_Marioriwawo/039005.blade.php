<x-tabel-entri-view :data="$data" :judultabel="$judultabel" :judultabelen="$judultabelen">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('bpd10') is-invalid @enderror" id="bpd10"
                                name="bpd10" value="{{ old('bpd10', $data->bpd10) }}">
                            @error('bpd10')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('youth10') is-invalid @enderror" id="youth10"
                                name="youth10" value="{{ old('youth10', $data->youth10) }}">
                            @error('youth10')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('p3a10') is-invalid @enderror" id="p3a10"
                                name="p3a10" value="{{ old('p3a10', $data->p3a10) }}">
                            @error('p3a10')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <tr>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('bpd11') is-invalid @enderror" id="bpd11"
                                name="bpd11" value="{{ old('bpd11', $data->bpd11) }}">
                            @error('bpd11')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('youth11') is-invalid @enderror" id="youth11"
                                name="youth11" value="{{ old('youth11', $data->youth11) }}">
                            @error('youth11')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('p3a11') is-invalid @enderror" id="p3a11"
                                name="p3a11" value="{{ old('p3a11', $data->p3a11) }}">
                            @error('p3a11')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <tr>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('bpd12') is-invalid @enderror" id="bpd12"
                                name="bpd12" value="{{ old('bpd12', $data->bpd12) }}">
                            @error('bpd12')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('youth12') is-invalid @enderror" id="youth12"
                                name="youth12" value="{{ old('youth12', $data->youth12) }}">
                            @error('youth12')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('p3a12') is-invalid @enderror" id="p3a12"
                                name="p3a12" value="{{ old('p3a12', $data->p3a12) }}">
                            @error('p3a12')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <tr>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('bpd13') is-invalid @enderror" id="bpd13"
                                name="bpd13" value="{{ old('bpd13', $data->bpd13) }}">
                            @error('bpd13')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('youth13') is-invalid @enderror" id="youth13"
                                name="youth13" value="{{ old('youth13', $data->youth13) }}">
                            @error('youth13')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <td class="tg-cly1"><input type="text"
                                class="form-control @error('p3a13') is-invalid @enderror" id="p3a13"
                                name="p3a13" value="{{ old('p3a13', $data->p3a13) }}">
                            @error('p3a13')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
            ...
            <table class="table table-bordered">
                <thead>
                    ...
                    <tr>
                        ...
                        <th class="tg-xxp7" colspan="2"><span style="font-weight:bold;font-style:italic">Number of
                                Villages/Urban Villages Institutional by Villages/Urban Villages in Marioriwawo
                                Subdistrict,
                                2021</span></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">1</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">3</span></td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">10</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">013. Soga</td>
                        <td class="tg-edh4"><span style="background-color:#EAF1DD">1</span></td>
    ...
    <x-slot name="script">
        {{-- //script disini --}}
        @include('tabel.skpd.039_marioriwawo.script5')
    </x-slot>
</x-tabel-entri-view>
