<x-tabel-entri-view :data="$data" :judultabel="$judultabel" :judultabelen="$judultabelen">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="tg-wa1i" colspan="2"><span style="font-weight:bold">Banyaknya Kelembagaan
                                Desa/Kelurahan Menurut Desa/Kelurahan di Kecamatan Citta, 2021</span></th>
                    </tr>
                    <tr>
                        <th class="tg-xxp7"><span style="font-weight:bold;font-style:italic">Table</span></th>
                        <th class="tg-xxp7" colspan="2"><span style="font-weight:bold;font-style:italic">Number of
                                Villages/Urban Villages Institutional by Villages/Urban Villages in Citta Subdistrict,
                                2021</span></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="tg-baqh" rowspan="2"><span style="font-style:normal;color:#000">P3A
                                (Perkumpulan
                                Petani Pemakai Air)/ </span><span style="font-style:italic;color:#000">Water User
                                Farmer
                                Association</span></td>
                    </tr>
                    <tr>
    ...
    <x-slot name="script">
        {{-- //script disini --}}
        @include('tabel.skpd.043_citta.script5')
    </x-slot>
</x-tabel-entri-view>
