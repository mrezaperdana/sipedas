                ...
                <thead>
                    <tr>
                        ...
                        <th class="tg-yla0"><span style="font-weight:bold">Jarak ke Ibukota Kecamatan dan ke Ibukota
                                Kabupaten Menurut Desa/Kelurahan di Kecamatan Donri-Donri, 2021</span></th>
                    </tr>
                    <tr>
                        <th class="tg-xxp7"><span style="font-weight:bold;font-style:italic">Table</span></th>
                        <th class="tg-sn55"><span style="font-weight:bold;font-style:italic">Distance to Capital
                                Subdistrict and Capital Regency by Villages/Urban Villages in Donri-Donri Subdistrict,
                                2021</span></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <td class="tg-cly1">001. Pesse</td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">5 km</span></td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">11 km</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">002. Pising</td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">1 km</span></td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">11 km</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">003. Labokong</td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">5 km</span></td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">17 km</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">004. Donri-Donri</td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">200 m</span></td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">14 km</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">005. Sering</td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">4 km</span></td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">17 km</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">006. Lalabata Riaja</td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">5 km</span></td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">21 km</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">007. Tottong</td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">6 km</span></td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">22 km</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">008. Leworeng</td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">7 km</span></td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">20 km</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">009. Kessing</td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">10 km</span></td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">19 km</span></td>
                    </tr>
                </tbody>
            </table>
