<x-tabel-entri-view :data="$data" :judultabel="$judultabel" :judultabelen="$judultabelen">
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        <th class="tg-wa1i"><span style="font-weight:bold">Tabel</span></th>
                        <th class="tg-amwm" rowspan="2">8.1</th>
                        <th class="tg-wa1i" colspan="5"><span style="font-weight:bold">Banyaknya Fasilitas
                                Olahraga
                                Menurut Desa/Kelurahan di Kecamatan Marioriawa, 2021</span></th>
                    </tr>
                    <tr>
                        <th class="tg-xxp7"><span style="font-weight:bold;font-style:italic">Table</span></th>
                        <th class="tg-xxp7" colspan="5"><span style="font-weight:bold;font-style:italic">Number of
                                Sport
                                Facilities by Villages/Urban Villages in Marioriawa Subdistrict, 2021</span></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="tg-nrix">Bola Basket/</td>
                    </tr>
                    <tr>
                        <td class="tg-lhti"><span style="font-style:italic">Villages/Urban Villages</span></td>
                        ...
                        <td class="tg-lhti"><span style="font-style:italic">Basketball</span></td>
                    </tr>
                    <tr>
                        <td class="tg-nrix">(1)</td>
                        <td class="tg-nrix">(2)</td>
    ...
    <x-slot name="script">
        {{-- //script disini --}}
        @include('tabel.skpd.046_marioriawa.script7')
