<x-tabel-entri-view :data="$data" :judultabel="$judultabel" :judultabelen="$judultabelen">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="tg-yla0"><span style="font-weight:bold">Banyaknya Surat Miskin dan Kartu Askeskin
                                Menurut
                                Desa/Kelurahan di Kecamatan Marioriawa, 2021</span></th>
                    </tr>
                    <tr>
                        <th class="tg-xxp7"><span style="font-weight:bold;font-style:italic">Table</span></th>
                        <th class="tg-sn55"><span style="font-weight:bold;font-style:italic">Number of Poor Letter and
                                Poor
                                Health Insurance Card by Villages/Urban Villages in Marioriawa Subdistrict, 2021</span>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <td class="tg-cly1">001. Patampanua</td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">120</span></td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">-</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">002. Panincong</td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">153</span></td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">153</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">003. Tellulimpoe</td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">37</span></td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">-</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">004. Attang Salo</td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">17</span></td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">307</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">005. Kaca</td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">21</span></td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">111</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">006. Limpomajang</td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">55</span></td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">252</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">007. Batu-Batu</td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">40</span></td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">89</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">008. Manorang Salo</td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">58</span></td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">228</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">009. Laringgi</td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">750</span></td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">250</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">010. Bulue</td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">16</span></td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">225</span></td>
                    </tr>
                    <tr>
                        <td class="tg-baqh"><span style="font-style:normal;color:#000">Jumlah/</span><span
                                style="font-style:italic;color:#000">Total</span></td>
                        <td class="tg-mwxe">1267</td>
                        <td class="tg-mwxe">1615</td>
                    </tr>
                </tbody>
            </table>
        </x-slot>
    ...
    <x-slot name="script">
        {{-- //script disini --}}
        @include('tabel.skpd.046_marioriawa.script6')
    </x-slot>
</x-tabel-entri-view>
