<x-tabel-entri-view :data="$data" :judultabel="$judultabel" :judultabelen="$judultabelen">
        ...
        <x-slot name="tabel2">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="tg-cly1">001. Timusu</td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">402</span></td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">3505</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">002. Rompegading</td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">384</span></td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">1178</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">003. Pattojo</td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">275</span></td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">2541</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">004. Galung</td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">293</span></td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">2857</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">005. Jennae</td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">651</span></td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">1681</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">006. Jampu</td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">393</span></td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">1705</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">007. Barang</td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">129</span></td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">174</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">011. Appanang</td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">323</span></td>
                        <td class="tg-lec9"><span style="background-color:#D7F3CB">2025</span></td>
                    </tr>
                    <tr>
                        <td class="tg-baqh"><span style="font-style:normal;color:#000">Jumlah/</span><span
                                style="font-style:italic;color:#000">Total</span></td>
                        <td class="tg-nrix">2850</td>
                        <td class="tg-nrix">16566</td>
                    </tr>
                </tbody>
            </table>
        </x-slot>
    ...
    <x-slot name="script">
        {{-- //script disini --}}
        @include('tabel.skpd.041_liliriaja.script6')
    </x-slot>
</x-tabel-entri-view>
