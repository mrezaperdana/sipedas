    ...
    <form action="/user/update/{{ $data->tipetabel }}/{{ $data->kodetabel }}"method="post" enctype="multipart/form-data">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td class="tg-cly1">020. Marioriaja</td>
                ...
                <tr>
                    ...
                    <td class="tg-cly1"><input type="text"
                            class="form-control @error('pos13') is-invalid @enderror" id="pos13" name="pos13"
                            value="{{ old('pos13', $data->pos13) }}">
                        @error('pos13')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <td class="tg-cly1"><input type="text"
                            class="form-control @error('telepon13') is-invalid @enderror" id="telepon13"
                            name="telepon13" value="{{ old('telepon13', $data->telepon13) }}">
                        @error('telepon13')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <td class="tg-cly1"><input type="text"
                            class="form-control @error('internet13') is-invalid @enderror" id="internet13"
                            name="internet13" value="{{ old('internet13', $data->internet13) }}">
                        @error('internet13')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
        ...
        <thead>
            <tr>
                ...
                <th class="tg-wa1i" colspan="2"><span style="font-weight:bold">Banyaknya Fasilitas Komunikasi dan
                        Informasi Menurut Desa/Kelurahan di Kecamatan Marioriwawo, {{ $data->tahun }}</span></th>
            </tr>
        </thead>
        <tbody>
            <tr>
                ...
                <td class="tg-xxp7" colspan="2"><span style="font-weight:bold;font-style:italic">Number of
                        Communication and Information Facilities by Villages/Urban Villages in Marioriwawo Subdistrict,
                        {{ $data->tahun }}</span></td>
            </tr>
            <tr>
                <td class="tg-cly1"></td>
