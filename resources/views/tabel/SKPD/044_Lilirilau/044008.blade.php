        ...
        <x-slot name="tabel2">
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th class="tg-cly1" colspan="2">Banyaknya Rumah Permanen, Rumah Sehat dan Rumah Tidak Sehat
                            Menurut Desa/Kelurahan di Kecamatan Lilirilau, 2021</th>
                    </tr>
                    <tr>
                        <th class="tg-xxp7"><span style="font-weight:bold;font-style:italic">Table</span></th>
                        <th class="tg-xxp7" colspan="2"><span style="font-weight:bold;font-style:italic">Number of
                                Permanent, Healthy and Non-Healthy House by Villages/Urban Villages in Lilirilau
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="tg-cly1">003. Paroto</td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">53</span></td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">6</span></td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">688</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">004. Palangiseng</td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">-</span></td>
                    ...
                    <tr>
                        <td class="tg-cly1">006. Abbanuange</td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">166</span></td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">0</span></td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">0</span></td>
                    </tr>
                    <tr>
                        <td class="tg-cly1">007. Parenring</td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">170</span></td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">0</span></td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">0</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="tg-cly1">011. Kebo</td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">83</span></td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">0</span></td>
                        <td class="tg-iygw"><span style="background-color:#D7F3CB">0</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="tg-baqh"><span style="font-style:normal;color:#000">Jumlah/</span><span
                                style="font-style:italic;color:#000">Total</span></td>
                        <td class="tg-mwxe">1599</td>
                        <td class="tg-mwxe">6</td>
                        <td class="tg-mwxe">688</td>
                    </tr>
                </tbody>
            </table>
        </x-slot>
