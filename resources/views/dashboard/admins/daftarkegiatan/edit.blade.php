                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.updatekegiatan', $data->id) }}" method="get"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input list="judulList" type="text"
                                        ...
                                        name="judul" required value="{{ old('judul', $data->judul) }}">
                                    @error('judul')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input list="tahunList" type="text"
                                        ...
                                        name="tahun" required value="{{ old('tahun', $data->tahun) }}">
                                    @error('tahun')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if ($data->template_file)
                                            <p>File name: {{ $data->template_file }}</p>
                                        @else
                                            <p>No file chosen</p>
                                        @endif
                                    </div>
