...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 d-flex">
                    <div class="image ">
                        <img src="{{ Auth::user()->picture }}" class="img-circle elevation-2 user_picture"
                            alt="User Image" />
                    </div>
                    <div class="info">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li
                            class="nav-item {{ request()->is('user/excels', 'user/DaftarEntri*', 'user/entriexcel*') ? 'menu-open' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('listExcels') }}"
                                        class="nav-link {{ request()->is('user/excels*') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Pengajuan Data</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('user.dashboard.DaftarEntri') }}"
                                        class="nav-link {{ request()->is('user/DaftarEntri*') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Daftar Entrian</p>
                                        <span class="badge badge-info right">{{ $notiftabel }}</span>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('listEntriExcels') }}"
                                        class="nav-link {{ request()->is('user/entriexcel*') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Entri Excel</p>
                                        <span class="badge badge-info right">{{ $notiftabel }}</span>
                                    </a>
    ...
    {{-- ijaboCropTool --}}
    <script src="/plugins/ijaboCropTool/ijaboCropTool.min.js"></script>
    <!-- ChartJS -->
