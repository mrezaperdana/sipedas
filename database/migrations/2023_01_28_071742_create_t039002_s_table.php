...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('t039002_s', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('jarakkec11')->nullable();
            $table->string('jarakkec12')->nullable();
            $table->string('jarakkec13')->nullable();
            ...
            $table->string('jarakkab11')->nullable();
            $table->string('jarakkab12')->nullable();
            $table->string('jarakkab13')->nullable();
        });
    }
