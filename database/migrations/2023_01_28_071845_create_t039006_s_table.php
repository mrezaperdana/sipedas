...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('t039006_s', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('miskin11')->nullable();
            $table->string('miskin12')->nullable();
            $table->string('miskin13')->nullable();
            ...
            $table->string('askeskin11')->nullable();
            $table->string('askeskin12')->nullable();
            $table->string('askeskin13')->nullable();
        });
    }
