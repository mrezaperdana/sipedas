...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('t039001_s', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('pantai11')->nullable();
            $table->string('pantai12')->nullable();
            $table->string('pantai13')->nullable();
            ...
            $table->string('bukanpantai11')->nullable();
            $table->string('bukanpantai12')->nullable();
            $table->string('bukanpantai13')->nullable();
            ...
            $table->string('datar11')->nullable();
            $table->string('datar12')->nullable();
            $table->string('datar13')->nullable();
            ...
            $table->string('bukit11')->nullable();
            $table->string('bukit12')->nullable();
            $table->string('bukit13')->nullable();
        });
    }
