...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('t039008_s', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('permanent10')->nullable();
            $table->string('permanent11')->nullable();
            $table->string('permanent12')->nullable();
            $table->string('permanent13')->nullable();
            ...
            $table->string('healthy10')->nullable();
            $table->string('healthy11')->nullable();
            $table->string('healthy12')->nullable();
            $table->string('healthy13')->nullable();
            ...
            $table->string('non10')->nullable();
            $table->string('non11')->nullable();
            $table->string('non12')->nullable();
            $table->string('non13')->nullable();
        });
    }
