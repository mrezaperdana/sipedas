...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('t039009_s', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('pool11')->nullable();
            $table->string('pool12')->nullable();
            $table->string('pool13')->nullable();
