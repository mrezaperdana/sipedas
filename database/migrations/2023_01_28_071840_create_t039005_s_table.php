...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('t039005_s', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('bpd10')->nullable();
            $table->string('bpd11')->nullable();
            $table->string('bpd12')->nullable();
            $table->string('bpd13')->nullable();
            ...
            $table->string('youth10')->nullable();
            $table->string('youth11')->nullable();
            $table->string('youth12')->nullable();
            $table->string('youth13')->nullable();
            ...
            $table->string('p3a10')->nullable();
            $table->string('p3a11')->nullable();
            $table->string('p3a12')->nullable();
            $table->string('p3a13')->nullable();
        });
    }
