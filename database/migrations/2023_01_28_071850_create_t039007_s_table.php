...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('t039007_s', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('football11', 9)->nullable();
            $table->string('football12', 9)->nullable();
            $table->string('football13', 9)->nullable();
            ...
            $table->string('volley11', 9)->nullable();
            $table->string('volley12', 9)->nullable();
            $table->string('volley13', 9)->nullable();
            ...
            $table->string('tennis11', 9)->nullable();
            $table->string('tennis12', 9)->nullable();
            $table->string('tennis13', 9)->nullable();
            ...
            $table->string('badminton11', 9)->nullable();
            $table->string('badminton12', 9)->nullable();
            $table->string('badminton13', 9)->nullable();
            ...
            $table->string('table_tennis11', 9)->nullable();
            $table->string('table_tennis12', 9)->nullable();
            $table->string('table_tennis13', 9)->nullable();
            ...
            $table->string('basketball11', 9)->nullable();
            $table->string('basketball12', 9)->nullable();
            $table->string('basketball13', 9)->nullable();
        });
    }
