...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('t047008_s', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('layak11')->nullable();
            $table->string('layak12')->nullable();
            $table->string('layak13')->nullable();
            ...
            $table->string('taklayak11')->nullable();
            $table->string('taklayak12')->nullable();
            $table->string('taklayak13')->nullable();
        });
    }
