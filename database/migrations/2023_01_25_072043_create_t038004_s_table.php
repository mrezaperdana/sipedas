...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('t038004_s', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('blind9')->nullable();
            $table->string('blind10')->nullable();
            ...
            $table->string('deaf9')->nullable();
            $table->string('deaf10')->nullable();
            ...
            $table->string('mentally_disabled9')->nullable();
            $table->string('mentally_disabled10')->nullable();
            ...
            $table->string('disabled9')->nullable();
            $table->string('disabled10')->nullable();
            ...
            $table->string('multiple_dissability9')->nullable();
            $table->string('multiple_dissability10')->nullable();
        });
    }
