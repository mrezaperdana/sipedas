...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('t025002_s', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('men11')->nullable();
            $table->string('men12')->nullable();
            ...
            $table->string('women11')->nullable();
            $table->string('women12')->nullable();
