...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('t039004_s', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('lingkungan13')->nullable();
